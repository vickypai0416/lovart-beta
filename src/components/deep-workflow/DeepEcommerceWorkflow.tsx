          ...
          <div className="space-y-6">
            ...
            <div className="space-y-6">
                    ...
                    {VISUAL_STYLES.map((s) => (
                      <SelectItem key={s.value} value={s.value}>
                        <div className="flex flex-col">
                          ...
                          <span className="text-xs text-gray-500 mt-1">适合: {s.bestFor}</span>
                        </div>
                      </SelectItem>
                    ))}
                  </SelectContent>
              ...
              <div>
                ...
                {/* Custom Color Picker - Simplified: Only select primary color */}
                {state.userPreferences.colorScheme === 'custom' && (
                  <div className="mt-4 p-4 border rounded-lg bg-gray-50">
                    <Label className="block mb-3">选择主色调</Label>
                    <div className="flex items-center gap-4">
                      <input
                        type="color"
                        value={state.userPreferences.customColors?.primary || '#F5F1E8'}
                        onChange={(e) => {
                          setState(prev => ({
                            ...prev,
                            userPreferences: {
                      ...
                      />
                      <div>
                        <p className="text-sm font-medium text-gray-700">主色</p>
                        <p className="text-xs text-gray-500">{state.userPreferences.customColors?.primary || '#F5F1E8'}</p>
                      </div>
                    </div>
                    <p className="text-xs text-gray-500 mt-3">AI将根据您选择的主色自动生成完整的配色方案</p>
                  </div>
                )}
              </div>
                    ...
                    {EMOTIONS.map((e) => (
                      <SelectItem key={e.value} value={e.value}>
                        <div className="flex flex-col">
                          ...
                          <span className="text-xs text-gray-500 mt-1">适合: {e.bestFor}</span>
                        </div>
                      </SelectItem>
                    ))}
                  </SelectContent>
