...
Image 2 - [特写标题]
标题文案：[英文标题，如"Exquisite Craftsmanship"]
副标题：[英文副标题，如"Premium Quality"]
用途：展示产品工艺细节和定制精美度
产品锚点：特写产品正面，定制区域为主
定制可见性：定制内容清晰突出
构图：产品特写，聚焦定制区域
...
构图：真实人物互动场景，自然的送礼瞬间捕捉
镜头：中景，捕捉人物面部表情和产品
光线：温暖自然的节日氛围光线
背景：温馨的家庭或节日场景，无礼盒礼袋卡片
风格：温馨、真实、情感化、生活化
禁止项：禁止出现礼盒、礼袋、小卡片等包装元素，人物必须露脸
最终生图提示词（可直接调用API）：
...
Image 6 - [细节标题]
标题文案：[英文标题，如"Premium Details"]
副标题：[英文副标题，如"Fine Craftsmanship"]
用途：展示产品细节品质，增强信任感
产品锚点：产品细节清晰展示
定制可见性：定制内容在细节图中仍可见
构图：产品边缘/侧面/背面特写
